...
const category = { id: 'dart', name: 'Dart', image: '/dart.svg', level: 'beginner' as const };
const previousNote = { id: 'dart-types', title: 'Tipos que explican la intención', description: '', category: 'dart', durationMinutes: 10, position: 1, format: 'written' as const, body: '' };
const nextNote = { id: 'dart-video', title: 'Dart en una sesión práctica', description: '', category: 'dart', durationMinutes: 15, position: 2, format: 'video' as const, youtubeVideoId: 'M7lc1UVf-VE', body: '' };
